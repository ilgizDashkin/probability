...
<Panel name="перестановка с повторениями из n элементов" img_name='img/combination_repetition.png' 
        ...
        name_input_1="количество различных элементов k" name_input_2="количество мест возможных сочетаний с повторениями этих элементов n" set_result={permutation_repetition} />
